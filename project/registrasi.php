...
<head>
    ...
    <title>Jastip Box | Registrasi</title>
...
<body>
        ...
        <div class="login-container">
            <form action="" method="post">
                ...
                <div class="input-div username">
                    ...
                    <div>
                        <input class="input" type="text" name="no_telp" placeholder="No. Telp" required>
                    </div>
                </div>
                ...
                <p class="signup">Sudah punya akun? <a href="login.php">Login</a></p>
    ...
    <div class="footer">
        <ul>
            ...
            <p>copyright &copy;2021 JASTIP BOX</p>
        </ul>
    </div>
    <!-- End Footer -->
